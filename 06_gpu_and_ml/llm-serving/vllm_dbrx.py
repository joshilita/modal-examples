...
vllm_image = (
    ...
    .pip_install(
        "https://github.com/vllm-project/vllm/releases/download/v0.4.0/vllm-0.4.0-cp310-cp310-manylinux1_x86_64.whl",  # vllm==0.4.0
...
class Model:
    ...
    def start_engine(self):
        ...
        engine_args = AsyncEngineArgs(
            ...
            trust_remote_code=BASE_MODEL
            == "databricks/dbrx-instruct",  # models not yet upstreamed to transformers require this
        )
